...
public final class Netstring {
    ...
    // throw new IllegalArgumentException("Expected , to terminate string in " +
    // buffer);
    // }
    //
    ...
    // throw new IllegalArgumentException("Length longer than " +
    ...
    // throw new IllegalArgumentException("Cannot parse netstring length from '"
    // + lengthString + "'",
    // exception);
    // }
    // } else {
